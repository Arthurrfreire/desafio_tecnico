...
config :w_core, WCoreWeb.Endpoint,
  ...
  secret_key_base: "nG+isq81JiAM/HV8df2rU8/5ZRd35DMmmIoh2wAtd7mlmOQOB6ybWsbbHCR6z1uZ",
  server: false

config :w_core, WCore.Telemetry.PersistenceWorker, flush_interval_ms: 60_000
